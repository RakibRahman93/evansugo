  ...
  return (
    <div className="container">
      ...
      <div id="isotope" className="mb-n100 mb-sm-n50">
        {(() => {
          let aiStillImagesHeaderDisplayed = false;

          return filtered.map((item, index) => (
            <div key={index} className="portfolio-2-item mb-30 mix">
              <div className="row">
                <div className="col-md-8 mb-sm-30">
                  <div className="portfolio-2-media">
                    {item.mediaType === "video" ? (
                      ...
                      <>
                        {!aiStillImagesHeaderDisplayed && (
                          <>
                            <h3>AI Still Images</h3>
                            {aiStillImagesHeaderDisplayed = true}
                          </>
                        )}
                        <img
                          src={item.mediaUrl}
